...
const Meso = () => {
    ...
    const [totalpropertytoggle, setTotalPropertyToggle] = useState<boolean>(false);
    ...
    const onInputChange = (e : React.ChangeEvent<HTMLInputElement>, setState : React.Dispatch<React.SetStateAction<number>>) => {
        const { value } = e.target;
                ...
                <Back>
                    ...
                    <Content>
                        <div>
                            ...
                            &nbsp; 재물 획득의 비약 &nbsp; x {propertynum}{' '}
                            <ButtonWrapper>
                                <Button
                                    width="25px"
                                    onClick={() =>
                                        setPropertyNum(onPlus(propertynum))
                                    }
                                >
                                    <FaArrowUp />
                                </Button>
                                <Button
                                    width="25px"
                                    onClick={() =>
                                        setPropertyNum(onMinus(propertynum))
                                    }
                                >
                                    <FaArrowDown />
                                </Button>
                        ...
                        <DivWithButton>
                            <div>수입 : {formatting(totalproperty)} 메소</div>
                            <DivBtn
                                onClick={() =>
                        ...
                        <div>
                            ...
                            <ButtonWrapper>
                                <Button
                                    width="25px"
                                    onClick={() =>
                                        setBossMesoNum(onPlus(bossmesonum))
                                    }
                                >
                                    <FaArrowUp />
                                </Button>
                                <Button
                                    width="25px"
                                    onClick={() =>
                                        setBossMesoNum(onMinus(bossmesonum))
                                    }
                                >
                                    <FaArrowDown />
                                </Button>
